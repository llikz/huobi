...
import com.hyphenate.easeui.utils.ChatDateUtil;
...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if (timestamp != null) {
            if (position == 0) {
                timestamp.setText(ChatDateUtil.getMultSimpleDays("" + message.getMsgTime()));
        ...
        if (messageSendCallback == null) {
            messageSendCallback = new EMCallBack() {
                ...
                public void onError(int code, String error) {
                    Log.i("erroreeeeeeee", "send msg error:" + error);
                    updateView();
                }
            };
        }
