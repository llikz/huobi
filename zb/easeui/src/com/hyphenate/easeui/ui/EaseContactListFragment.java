...
import com.hyphenate.easeui.inface.GItemClickListener;
...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    protected TextView addTv,newFriendsMsgTv;
    ...
    protected void initView() {
        ...
        addTv = (TextView)getView().findViewById(R.id.tv_add_friend);
        newFriendsMsgTv = (TextView)getView().findViewById(R.id.tv_add_friend_msg);
    ...
    protected void setUpView() {
        ...
        contactListLayout.setOnAvatarClickListener(new GItemClickListener() {
            @Override
            public void onItemClicked(View vs, int pos, EaseUser user) {
                if (listener != null) {
                    listener.onItemClicked(vs, pos,user);
                }
            }
        });
    ...
    public void setNewFriendMsg(int num){
        if(newFriendsMsgTv!=null){
            if(num>0) {
                newFriendsMsgTv.setText("" + num);
                newFriendsMsgTv.setVisibility(View.VISIBLE);
            }else{
                newFriendsMsgTv.setVisibility(View.INVISIBLE);
            }
        }
    }
    OnClickListener addlistener = null;
    public void setOnNewFriendItem(OnClickListener l){
        addlistener = l;
    }
    ...
    public void setOnAvatarClickListener(GItemClickListener l) {
        listener = l;
    }
