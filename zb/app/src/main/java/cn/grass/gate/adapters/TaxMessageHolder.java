 ...
 */
public class TaxMessageHolder extends RecyclerView.ViewHolder implements View.OnClickListener{

    TextView titleTv,publishTv,dateTv;

    public TaxMessageHolder(View itemView, GItemClickListener l) {
        super(itemView);
        listener = l;
