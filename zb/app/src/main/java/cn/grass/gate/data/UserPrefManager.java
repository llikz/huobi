...
/**
 * 根据每个用户uid来做存不同的偏好设置Preferences管理类
 * @author weedys
 */
public class UserPrefManager {
	...
	public static SharedPreferences getSharedPreferences(){
		return  getSharedPreferences(GrassApp.getInstance().getUserId());
	}
	/**
	 * 统一的SharedPreferences接口
	 * @param context
	 * @return SharedPreferences
	 */
	public static SharedPreferences getSharedPreferences(String uid){
		return GrassApp.getInstance().getSharedPreferences("settings"+uid, 0);
	}
	/**
	 * 统一的Editor接口
	 * @return Editor
