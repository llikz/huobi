 ...
 */
public class ExerciseNotebookHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    TextView titleTv;

    public ExerciseNotebookHolder(View itemView, GItemClickListener l) {
        super(itemView);
        listener = l;
