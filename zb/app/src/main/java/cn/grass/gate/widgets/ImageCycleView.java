 ...
 *   使用：只需在xml文件中使用{@code <.ImageCycleView/>} ，
...
public class ImageCycleView extends LinearLayout {
    ...
    public void setImageResources(ArrayList<ADInfo> infoList, ImageCycleViewListener imageCycleViewListener) {
        ...
        for (int i = 0; i < imageCount; i++) {
            ...
            if (i == 0) {
                mImageViews[i].setBackgroundResource(R.mipmap.icon_point_seslect);
            } else {
                mImageViews[i].setBackgroundResource(R.mipmap.icon_point_default);
            }
    ...
    private final class GuidePageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int index) {
            ...
            mImageIndex = index;
            index -= 1;
            mImageViews[index].setBackgroundResource(R.mipmap.icon_point_seslect);
