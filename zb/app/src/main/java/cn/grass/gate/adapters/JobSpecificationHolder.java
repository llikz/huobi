 ...
 */
public class JobSpecificationHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    TextView titleTv;
    ImageView iconIgv;

    public JobSpecificationHolder(View itemView, GItemClickListener l) {
        super(itemView);
        listener = l;
