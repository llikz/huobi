...
import cn.grass.gate.adapters.PostRiskAdapter;
 ...
 */
public class PostRiskFragment extends BaseFragment {
    @Nullable
    @Override
    ...
    private void initView(View v) {
        ...
        tList = new ArrayList<>();
        adapter = new PostRiskAdapter(getActivity(), tList);
