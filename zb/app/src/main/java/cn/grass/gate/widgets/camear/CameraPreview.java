package cn.grass.gate.widgets.camear;
...
import cn.grass.gate.utils.Utils;
...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback, Camera.AutoFocusCallback {
    ...
    private void setParameters(Camera.Parameters p) {
        ...
        p.setColorEffect(Camera.Parameters.EFFECT_MONO   );//TODO 自定义黑白效果
        // 设置照片格式
        p.setPictureFormat(PixelFormat.JPEG);
        Camera.Size previewSize = findPreviewSizeByScreen(p);
        p.setPreviewSize(previewSize.width, previewSize.height);
        p.setPictureSize(previewSize.width, previewSize.height);
//        p.setFocusMode(Camera.Parameters.FOCUS_MODE_AUTO);//自动对焦模式
        p.setFocusMode(Camera.Parameters.FOCUS_MODE_CONTINUOUS_PICTURE);//连续自动对焦模式用于拍照
    ...
    public void focusOnTouch(MotionEvent event) {
        ...
        parameters.setColorEffect(Camera.Parameters.EFFECT_MONO   );//TODO 自定义黑白效果
