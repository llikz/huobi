...
import cn.grass.gate.adapters.ConsultAdapter;
...
public class MainFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View vs = inflater.inflate(R.layout.fragment_main, container, false);
        initView(vs);
        return vs;
    }
    ...
    View errorView = null;
    ConsultAdapter adapter = null;
    ArrayList<ConsultInfo> cList =null;
    private void initView(View v) {
        ...
        cList = new ArrayList<>();
        adapter = new ConsultAdapter(getActivity(), cList);
    ...
    private void initData() {
        for (int i = 0;i<10;i++){
            ConsultInfo info = new ConsultInfo();
            info.title= "非居民企业股权转让纳税申报"+(i+10);
            info.consultId = i+"";
            cList.add(info);
        }
