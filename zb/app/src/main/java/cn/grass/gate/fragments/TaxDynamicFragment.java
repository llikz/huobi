...
import cn.grass.gate.adapters.TaxMessageAdapter;
 ...
 * 税务动态、工作指导、最新案例
 */
public class TaxDynamicFragment extends BaseFragment implements ArticleView {
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View contentView=inflater.inflate(R.layout.fragment_tax_dynamic,null);
    ...
    private void initView(View v) {
        ...
        if (bundle != null) {
            columnId = bundle.getString(IntentParameter.COLUMN_ID,IntentParameter.ID_TAX_DYNAMIC);
        }
        ...
        pullRefreshLayout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                page = 1;
//                presenter.getArticleList(columnId,page,pageSize);
            }
        });
...
//                presenter.getArticleList(columnId,page,pageSize);
        ...
        searchEt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                SearchArticleActivity.startSearchArticleActivity(getActivity(),columnId);
            }
        });
